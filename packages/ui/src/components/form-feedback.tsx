...
> = {
	error: {
		icon: XCircle,
		containerClass:
			"bg-[var(--toast-error-bg)] border-[var(--toast-error-border)]",
		textClass: "text-[var(--toast-error-text)]",
	},
	success: {
		icon: CheckCircle2,
		containerClass:
			"bg-[var(--toast-success-bg)] border-[var(--toast-success-border)]",
		textClass: "text-[var(--toast-success-text)]",
	},
	warning: {
		icon: AlertCircle,
		containerClass:
			"bg-[var(--toast-warning-bg)] border-[var(--toast-warning-border)]",
		textClass: "text-[var(--toast-warning-text)]",
	},
	info: {
		icon: Info,
		containerClass:
			"bg-[var(--toast-info-bg)] border-[var(--toast-info-border)]",
