 ...
 * Used for mobile navigation, settings panels, etc.
 */
...
const sheetVariants = cva(
	'fixed z-modal gap-4 bg-background shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
	{
		variants: {
			side: {
