...
function getInputClasses(state: { error?: string; success?: string }, className?: string) {
	return cn(
...
function getTextareaClasses(state: { error?: string; success?: string }, className?: string) {
	return cn(
