...
describe('staggerContainerFast', () => {
	...
	test('animate configures stagger children', () => {
		expect(staggerContainerFast.animate.transition.staggerChildren).toBe(stagger.fast)
		expect(staggerContainerFast.animate.transition.delayChildren).toBe(0)
	})

	test('exit staggers in reverse faster', () => {
		expect(staggerContainerFast.exit.transition.staggerChildren).toBe(stagger.fast / 2)
...
describe('staggerContainer', () => {
	test('uses normal stagger timing', () => {
		expect(staggerContainer.animate.transition.staggerChildren).toBe(stagger.normal)
	})
