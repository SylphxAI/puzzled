...
import type { FlagDefinition, EvaluationContext } from '../src/lib/flags/types'
...
describe('LocalEvaluator', () => {
	...
	describe('flag management', () => {
		...
		test('removeFlag removes a flag', () => {
			evaluator.setFlags([createBasicFlag('flag-1'), createBasicFlag('flag-2')])
		...
		test('getFlags returns all flags', () => {
			const flags = [createBasicFlag('a'), createBasicFlag('b'), createBasicFlag('c')]
