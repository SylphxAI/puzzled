...
describe('getStreak', () => {
	test('fetches streak from correct endpoint', async () => {
		...
		expect(url).toContain('/api/v1/engagement/streaks/get')
	})
...
describe('getAllStreaks', () => {
	test('fetches all streaks from correct endpoint', async () => {
		...
		const url = getRequestUrl()
		expect(url).toContain('/api/v1/engagement/streaks')
...
describe('recordStreakActivity', () => {
	test('posts to correct endpoint', async () => {
		...
		const url = getRequestUrl()
		expect(url).toContain('/api/v1/engagement/streaks/record')
	...
	test('returns activity result', async () => {
		...
		const result = await recordStreakActivity(testConfig, { streakId: 'daily-login' }, 'user-123')
...
describe('recoverStreak', () => {
	test('posts to correct endpoint', async () => {
		...
		const url = getRequestUrl()
		expect(url).toContain('/api/v1/engagement/streaks/recover')
		expect(getRequestMethod()).toBe('POST')
	})
...
describe('getLeaderboard', () => {
	test('fetches leaderboard from correct endpoint', async () => {
		...
		const url = getRequestUrl()
		expect(url).toContain('/api/v1/engagement/leaderboards/get')
		expect(getRequestMethod()).toBe('GET')
	})
...
describe('submitScore', () => {
	test('posts to correct endpoint', async () => {
		...
		const url = getRequestUrl()
		expect(url).toContain('/api/v1/engagement/leaderboards/submit')
		expect(getRequestMethod()).toBe('POST')
	})
...
describe('getUserLeaderboardRank', () => {
	test('fetches rank from correct endpoint', async () => {
		...
		const url = getRequestUrl()
		expect(url).toContain('/api/v1/engagement/leaderboards/rank')
		expect(url).toContain('leaderboardId=high-scores')
		expect(url).toContain('userId=user-123')
	})
...
describe('getAchievements', () => {
	test('fetches achievements from correct endpoint', async () => {
		...
		const url = getRequestUrl()
		expect(url).toContain('/api/v1/engagement/achievements')
		expect(url).toContain('userId=user-123')
	})
...
describe('getAchievement', () => {
	test('fetches single achievement from correct endpoint', async () => {
		...
		const url = getRequestUrl()
		expect(url).toContain('/api/v1/engagement/achievements/get')
...
describe('unlockAchievement', () => {
	test('posts to correct endpoint', async () => {
		...
		const url = getRequestUrl()
		expect(url).toContain('/api/v1/engagement/achievements/unlock')
		expect(getRequestMethod()).toBe('POST')
	})
...
describe('incrementAchievementProgress', () => {
	test('posts to correct endpoint', async () => {
		...
		const url = getRequestUrl()
		expect(url).toContain('/api/v1/engagement/achievements/progress')
		expect(getRequestMethod()).toBe('POST')
	})
...
describe('getAchievementPoints', () => {
	test('fetches points from correct endpoint', async () => {
		...
		const url = getRequestUrl()
		expect(url).toContain('/api/v1/engagement/achievements/points')
		expect(url).toContain('userId=user-123')
	})
