...
type ConsentCategory = 'necessary' | 'analytics' | 'marketing' | 'functional' | 'social'
...
describe('hasConsent logic', () => {
	const types: ConsentType[] = [
		{ id: '1', slug: 'essential', name: 'Essential', description: '', category: 'necessary', required: true, defaultEnabled: true },
		{ id: '2', slug: 'google-analytics', name: 'Google Analytics', description: '', category: 'analytics', required: false, defaultEnabled: false },
		{ id: '3', slug: 'marketing-cookies', name: 'Marketing', description: '', category: 'marketing', required: false, defaultEnabled: false },
		{ id: '4', slug: 'functional-storage', name: 'Functional', description: '', category: 'functional', required: false, defaultEnabled: true },
	]

	function hasConsent(category: ConsentCategory, consents: Record<string, boolean>): boolean {
...
describe('Consent state initialization', () => {
	...
	test('converts user consents array to map', () => {
		function consentsToMap(userConsents: UserConsent[]): Record<string, boolean> {
...
describe('Accept all logic', () => {
	test('sets all consent types to true', () => {
		const types: ConsentType[] = [
			{ id: '1', slug: 'analytics', name: 'Analytics', description: '', category: 'analytics', required: false, defaultEnabled: false },
			{ id: '2', slug: 'marketing', name: 'Marketing', description: '', category: 'marketing', required: false, defaultEnabled: false },
			{ id: '3', slug: 'functional', name: 'Functional', description: '', category: 'functional', required: false, defaultEnabled: false },
		]
...
describe('Decline optional logic', () => {
	test('sets only required consents to true', () => {
		const types: ConsentType[] = [
			{ id: '1', slug: 'essential', name: 'Essential', description: '', category: 'necessary', required: true, defaultEnabled: true },
			{ id: '2', slug: 'analytics', name: 'Analytics', description: '', category: 'analytics', required: false, defaultEnabled: false },
			{ id: '3', slug: 'marketing', name: 'Marketing', description: '', category: 'marketing', required: false, defaultEnabled: false },
		]
...
describe('Save consents logic', () => {
	...
	test('falls back to defaultEnabled for missing consents', () => {
		const types: ConsentType[] = [
			{ id: '1', slug: 'analytics', name: 'Analytics', description: '', category: 'analytics', required: false, defaultEnabled: false },
			{ id: '2', slug: 'functional', name: 'Functional', description: '', category: 'functional', required: false, defaultEnabled: true },
		]
