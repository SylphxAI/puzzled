...
describe('addBreadcrumb', () => {
	describe('basic functionality', () => {
		...
		test('adds multiple breadcrumbs', () => {
			addBreadcrumb({ type: 'ui', category: 'click', message: 'First', level: 'info' })
			addBreadcrumb({ type: 'ui', category: 'click', message: 'Second', level: 'info' })
			addBreadcrumb({ type: 'ui', category: 'click', message: 'Third', level: 'info' })
...
describe('getBreadcrumbs', () => {
	...
	test('returns copy of breadcrumbs array', () => {
		addBreadcrumb({ type: 'ui', category: 'test', message: 'Test', level: 'info' })
	...
	test('modifying returned array does not affect store', () => {
		addBreadcrumb({ type: 'ui', category: 'test', message: 'Original', level: 'info' })

		const breadcrumbs = getBreadcrumbs()
		breadcrumbs.push({ type: 'ui', category: 'fake', message: 'Fake', level: 'info', timestamp: 0 })

		expect(getBreadcrumbs().length).toBe(1)
	})

	test('returns breadcrumbs in order added', () => {
		addBreadcrumb({ type: 'ui', category: 'test', message: 'First', level: 'info' })
		addBreadcrumb({ type: 'ui', category: 'test', message: 'Second', level: 'info' })
		addBreadcrumb({ type: 'ui', category: 'test', message: 'Third', level: 'info' })
...
describe('clearBreadcrumbs', () => {
	test('removes all breadcrumbs', () => {
		addBreadcrumb({ type: 'ui', category: 'test', message: 'One', level: 'info' })
		addBreadcrumb({ type: 'ui', category: 'test', message: 'Two', level: 'info' })
		addBreadcrumb({ type: 'ui', category: 'test', message: 'Three', level: 'info' })
	...
	test('allows adding new breadcrumbs after clear', () => {
		addBreadcrumb({ type: 'ui', category: 'test', message: 'Before', level: 'info' })
		clearBreadcrumbs()
		addBreadcrumb({ type: 'ui', category: 'test', message: 'After', level: 'info' })
...
describe('setMaxBreadcrumbs', () => {
	test('limits number of stored breadcrumbs', () => {
		...
		addBreadcrumb({ type: 'ui', category: 'test', message: '1', level: 'info' })
		addBreadcrumb({ type: 'ui', category: 'test', message: '2', level: 'info' })
		addBreadcrumb({ type: 'ui', category: 'test', message: '3', level: 'info' })
		addBreadcrumb({ type: 'ui', category: 'test', message: '4', level: 'info' })
		addBreadcrumb({ type: 'ui', category: 'test', message: '5', level: 'info' })
	...
	test('keeps most recent breadcrumbs', () => {
		...
		addBreadcrumb({ type: 'ui', category: 'test', message: 'Old', level: 'info' })
		addBreadcrumb({ type: 'ui', category: 'test', message: 'Recent', level: 'info' })
		addBreadcrumb({ type: 'ui', category: 'test', message: 'Newest', level: 'info' })
