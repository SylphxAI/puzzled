...
import { deleteFile, getFileUrl, getFileInfo, type FileInfo } from '../src/storage'
...
describe('deleteFile', () => {
	...
	test('throws on unauthorized', async () => {
		...
		await expect(deleteFile(config, 'file-123')).rejects.toThrow('Not authorized to delete this file')
	})
})
