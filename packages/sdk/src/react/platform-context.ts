...
import type { Plan, ReferralStats, Subscription, User } from "../types";
...
import type { RedeemResult, ReferralRewardDefaults } from "../referrals";
...
export interface PlatformContextValue {
	...
	getReferralLeaderboard: (options?: {
		limit?: number;
