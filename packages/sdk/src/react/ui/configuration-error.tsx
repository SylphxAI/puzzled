		...
		<div style={styles.devCard}>
			...
			<div style={styles.devHeader}>
				...
				<div>
					...
					<p style={styles.devSubtitle}>
						Complete setup to enable authentication
					</p>
				</div>
			</div>
			...
			<div style={styles.stepsContainer}>
				...
				<div style={styles.step}>
					...
					<div style={styles.stepContent}>
						...
						<p style={styles.stepDescription}>
							Run <code style={styles.inlineCode}>npm run dev</code> or restart
							your server to load the new environment variables.
						</p>
					</div>
				</div>
			</div>
