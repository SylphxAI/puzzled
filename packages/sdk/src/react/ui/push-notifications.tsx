	...
	const containerStyle: CSSProperties = mergeStyles(
		{
			...
			animation: isAnimatingOut
				? "sylphx-fade-out 0.2s ease"
				: "sylphx-slide-up 0.3s ease",
		},
	...
	if (variant === "banner") {
		...
		return (
			<div style={bannerStyle} className={className}>
				...
				<div style={{ flex: 1 }}>
					<p style={{ margin: 0, fontWeight: 600, fontSize: theme.fontSizeSm }}>
						{title}
					</p>
					<p
						style={mergeStyles(styles.textXs, styles.textMuted, { margin: 0 })}
					>
						{description}
					</p>
				</div>
			...
			<div style={listStyle}>
				{notifications.length === 0 ? (
					...
					>
						...
						<p style={{ marginTop: "0.5rem", fontSize: theme.fontSizeSm }}>
							{emptyMessage}
						</p>
					</div>
				) : (
