...
export function UnsubscribeConfirm({
	...
	const handleResubscribe = async () => {
		...
		try {
			...
			const message =
				err instanceof Error ? err.message : "Failed to resubscribe";
			setError(message);
			setStatus("error");
		}
	};
			...
			case "processing":
				return (
					<div style={{ textAlign: "center", padding: "2rem" }}>
						...
						<p style={{ marginTop: "1rem", fontSize: theme.fontSizeBase }}>
							Processing...
						</p>
					</div>
				);
					...
					<>
						...
						{showResubscribe && (
							<div style={{ marginTop: "1.5rem" }}>
								<p style={mergeStyles(styles.textSm, styles.textMuted)}>
									Changed your mind?
								</p>
								<button
									type="button"
			...
			case "missing_token":
				return (
					<>
						...
						>
							The unsubscribe link is missing or expired. Please use the link
							from your email.
						</p>
						{redirectUrl && (
							<a
