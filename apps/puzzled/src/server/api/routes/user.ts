...
userRoutes.put('/profile', authRateLimitMiddleware, async (c) => {
...
userRoutes.get('/check-username', authRateLimitMiddleware, async (c) => {
...
userRoutes.put('/preferences', authRateLimitMiddleware, async (c) => {
	const body = await c.req.json()
