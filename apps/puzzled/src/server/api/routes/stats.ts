...
statsRoutes.get('/today-percentile', rateLimitMiddleware, async (c) => {
...
statsRoutes.get('/user-stats', authMiddleware, async (c) => {
...
statsRoutes.get('/user-rank', authMiddleware, async (c) => {
	const query = c.req.query()
