		...
		<div className="space-y-4">
			...
			<div className="space-y-3">
				...
				<p className="text-center text-xs text-muted-foreground">
					The <span className="font-bold text-amber-500">center letter</span> must be in every word
				</p>
			</div>
			...
			<div className="space-y-2">
				...
				<div className="space-y-1 text-xs text-muted-foreground">
					...
					<p>
						• <span className="font-medium text-amber-500">{t('pangram')}</span> (uses all 7
						letters): {t('pangramBonus')}
					</p>
				</div>
			</div>
		</div>
