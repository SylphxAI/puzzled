...
const GAME_COLOR_THEMES: Record<GameColorTheme, GameColorClasses> = {
	emerald: {
		...
		pattern:
			"bg-[radial-gradient(circle_at_80%_20%,rgba(16,185,129,0.15),transparent_50%)]",
	},
	cyan: {
		...
		pattern:
			"bg-[radial-gradient(circle_at_80%_20%,rgba(6,182,212,0.15),transparent_50%)]",
	},
	violet: {
	...
	amber: {
		...
		pattern:
			"bg-[radial-gradient(circle_at_80%_20%,rgba(245,158,11,0.15),transparent_50%)]",
	},
	pink: {
		...
		pattern:
			"bg-[radial-gradient(circle_at_80%_20%,rgba(236,72,153,0.15),transparent_50%)]",
	},
	rose: {
		...
		pattern:
			"bg-[radial-gradient(circle_at_80%_20%,rgba(244,63,94,0.15),transparent_50%)]",
	},
	blue: {
		...
		pattern:
			"bg-[radial-gradient(circle_at_80%_20%,rgba(59,130,246,0.15),transparent_50%)]",
	},
	sky: {
		...
		pattern:
			"bg-[radial-gradient(circle_at_80%_20%,rgba(14,165,233,0.15),transparent_50%)]",
	},
	orange: {
		...
		pattern:
			"bg-[radial-gradient(circle_at_80%_20%,rgba(249,115,22,0.15),transparent_50%)]",
	},
	lime: {
		...
		pattern:
			"bg-[radial-gradient(circle_at_80%_20%,rgba(132,204,22,0.15),transparent_50%)]",
	},
	slate: {
		...
		pattern:
			"bg-[radial-gradient(circle_at_80%_20%,rgba(100,116,139,0.15),transparent_50%)]",
	},
} as const;
