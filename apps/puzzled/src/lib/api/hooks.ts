...
export const queryKeys = {
	...
	checkUsername: (username: string) =>
		["user", "checkUsername", username] as const,
	...
	dlq: (params?: { workflow?: string; status?: string }) =>
		["admin", "dlq", params] as const,
...
async function parseResponse<T>(response: Response): Promise<T> {
	...
	try {
		...
		console.error(
			"[Puzzled API] Failed to parse success response:",
			parseError,
		);
...
export function useUserStats(
	options?: Omit<
		UseQueryOptions<UserStatsResponse, ApiError>,
		"queryKey" | "queryFn"
	>,
) {
	return useQuery({
...
export function useTodayPercentile(
	...
	options?: Omit<
		UseQueryOptions<TodayPercentileResponse, ApiError>,
		"queryKey" | "queryFn"
	>,
) {
	return useQuery({
...
export function useDlqList(
	...
	options?: Omit<
		UseQueryOptions<DLQListResponse, ApiError>,
		"queryKey" | "queryFn"
	>,
) {
	return useQuery({
...
export function useAuditLogs(
	...
	options?: Omit<
		UseQueryOptions<AuditLogsResponse, ApiError>,
		"queryKey" | "queryFn"
	>,
) {
	return useQuery({
...
export function useAuditLogDetails(
	id: string,
	options?: Omit<
		UseQueryOptions<AuditLogItem, ApiError>,
		"queryKey" | "queryFn"
	>,
) {
	return useQuery({
...
export function useGamesOverview(
	options?: Omit<
		UseQueryOptions<GameOverviewItem[], ApiError>,
		"queryKey" | "queryFn"
	>,
) {
	return useQuery({
...
export function useGameAnalytics(
	...
	days = 30,
	options?: Omit<
		UseQueryOptions<GameAnalyticsResponse, ApiError>,
		"queryKey" | "queryFn"
	>,
) {
	return useQuery({
		...
		queryFn: async () => {
			...
			const res = await fetch(
				`/api/v1/admin/analytics/game/${slug}?days=${days}`,
				{
					credentials: "include",
				},
			);
...
export function useSystemHealth(
	options?: Omit<
		UseQueryOptions<SystemHealthResponse, ApiError>,
		"queryKey" | "queryFn"
	>,
) {
	return useQuery({
