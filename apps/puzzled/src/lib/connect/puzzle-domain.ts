...
export type SubmitGuessInput = {
	...
	/**
	 * Served-puzzle identity. puzzleId (stored daily/archive puzzle) is
	 * preferred; puzzleDate (YYYY-MM-DD) applies for date-derived puzzles.
	 * The server derives the served puzzle itself — client seeds are never
	 * authority inputs.
	 */
	puzzleId?: string
	puzzleDate?: string
