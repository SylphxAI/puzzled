				...
				<div className="flex items-start gap-4">
					...
					<div>
						...
						<p className="mt-1 text-sm text-[var(--admin-text-secondary)]">
							App-specific settings are configured through feature flags and
							announcements. For user management, billing, and authentication
							settings, use the platform admin.
						</p>
					</div>
				</div>
			</div>
