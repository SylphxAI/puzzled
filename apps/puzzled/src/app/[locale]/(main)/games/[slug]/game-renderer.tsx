...
const ArithmoGame = dynamic(
	() =>
		import('@/games/arithmo/arithmo-game').then((m) => ({
			default: m.ArithmoGame,
		})),
	{ ssr: false },
)
const BlockSlideGame = dynamic(
	() =>
		import('@/games/block-slide/block-slide-game').then((m) => ({
			default: m.BlockSlideGame,
		})),
	{ ssr: false },
)
const CrosswordGame = dynamic(
	() =>
		import('@/games/crossword/crossword-game').then((m) => ({
			default: m.CrosswordGame,
		})),
	{ ssr: false },
)
const CryptogramGame = dynamic(
	() =>
		import('@/games/cryptogram/cryptogram-game').then((m) => ({
			default: m.CryptogramGame,
		})),
	{ ssr: false },
)
...
const NonogramGame = dynamic(
	() =>
		import('@/games/nonogram/nonogram-game').then((m) => ({
			default: m.NonogramGame,
		})),
	{ ssr: false },
)
...
const QuadWordsGame = dynamic(
	() =>
		import('@/games/quad-words/quad-words-game').then((m) => ({
			default: m.QuadWordsGame,
		})),
	{ ssr: false },
)
const QueensGame = dynamic(
	() =>
		import('@/games/queens/queens-game').then((m) => ({
			default: m.QueensGame,
		})),
	{ ssr: false },
)
const SudokuGame = dynamic(
	() =>
		import('@/games/sudoku/sudoku-game').then((m) => ({
...
const WordBoxGame = dynamic(
	() =>
		import('@/games/word-box/word-box-game').then((m) => ({
			default: m.WordBoxGame,
		})),
	{ ssr: false },
)
const WordGroupsGame = dynamic(
	() =>
		import('@/games/word-groups/word-groups-game').then((m) => ({
			default: m.WordGroupsGame,
		})),
	{ ssr: false },
)
const WordGuessGame = dynamic(
	() =>
		import('@/games/word-guess/word-guess-game').then((m) => ({
			default: m.WordGuessGame,
		})),
	{ ssr: false },
)
const WordHiveGame = dynamic(
	() =>
		import('@/games/word-hive/word-hive-game').then((m) => ({
			default: m.WordHiveGame,
		})),
	{ ssr: false },
)
const WordLadderGame = dynamic(
	() =>
		import('@/games/word-ladder/word-ladder-game').then((m) => ({
			default: m.WordLadderGame,
		})),
	{ ssr: false },
)
const WordSearchGame = dynamic(
	() =>
		import('@/games/word-search/word-search-game').then((m) => ({
			default: m.WordSearchGame,
		})),
	{ ssr: false },
)
