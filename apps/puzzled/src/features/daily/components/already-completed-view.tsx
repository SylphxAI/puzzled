 ...
 */
function getCelebrationMessage(attempts: number, maxAttempts = 6): string {
...
export function AlreadyCompletedView({
	...
	const celebrationMessage = isWin
		? getCelebrationMessage(session.attempts)
		: null;
	...
	return (
		...
		>
			...
			<Card
				className={cn(
					"w-full",
					animate && "animate-slide-up-fade opacity-0 stagger-4",
				)}
			>
