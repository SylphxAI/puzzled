...
function getMilestoneTier(
	streak: number,
): "starter" | "bronze" | "silver" | "gold" | "legendary" {
	...
	if (variant === "detailed") {
		...
		const getMilestoneBadge = () => {
			if (currentStreak === 365)
				return { text: "365-Day Streak!", icon: "mdi:fire" };
			if (currentStreak === 100)
				return { text: "100-Day Streak!", icon: "mdi:fire" };
			if (currentStreak === 30)
				return { text: "30-Day Streak!", icon: "mdi:fire" };
			if (currentStreak === 7)
				return { text: "7-Day Streak!", icon: "mdi:fire" };
			return null;
		};
					...
					<div className="flex items-center gap-3">
						...
						<div>
							<div className="flex items-baseline gap-2">
								<span
									className={cn("text-3xl font-bold tabular-nums", style.text)}
								>
									{currentStreak}
								</span>
