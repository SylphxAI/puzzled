...
test.describe('Authentication Pages', () => {
		...
		test('should show validation error for empty submission', async ({ page }) => {
			...
			const hasValidationError = await page.evaluate(() => {
				...
				return Array.from(inputs).some(
					(input) => !input.validity.valid || input.getAttribute('aria-invalid') === 'true'
				)
			})
	...
	test.describe('Signup Page', () => {
		...
		test('should have name/username field', async ({ page }) => {
			...
			const nameInput = page.locator('input[name="name"], input[name="username"], input[placeholder*="name" i]')
		...
		test('should show password requirements', async ({ page }) => {
			...
			const requirements = page.getByText(/characters|uppercase|lowercase|number|special/i)
	...
	test.describe('Forgot Password Page', () => {
		...
		test('should have link back to login', async ({ page }) => {
			...
			const hasAnyLink = await anyLink.first().isVisible().catch(() => false)
	...
	test.describe('Auth Redirects', () => {
		...
		test('should preserve callbackUrl after login redirect', async ({ page }) => {
			...
			const callbackUrl = url.searchParams.get('callbackUrl') || url.searchParams.get('callback') || url.searchParams.get('redirect')
