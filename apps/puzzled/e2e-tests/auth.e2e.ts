...
test.describe('Authentication Pages', () => {
	test.describe('Login Page', () => {
		...
		test('should show validation error for empty submission', async ({ page }) => {
			...
			const _hasValidationError = await page.evaluate(() => {
		...
		test('should show OAuth providers if configured', async ({ page }) => {
			...
			const _oauthButtons = page.locator(
	...
	test.describe('Signup Page', () => {
		...
		test('should show password requirements', async ({ page }) => {
			...
			const _requirements = page.getByText(/characters|uppercase|lowercase|number|special/i)
