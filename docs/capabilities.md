...
| PUZ-PLUS | Paid archive, suite, and stats | dead | PUZ-FREE | Retired 2026-09-25: the Sylphx commerce service it read does not exist, so nothing could be bought. Archive, the whole suite and stats are free to every player. A paid tier returns only through open issue [#235](https://github.com/SylphxAI/puzzled/issues/235) (Stripe is the allowed merchant exception); never sell the solution or charge mid-failure of the free daily attempt. |
