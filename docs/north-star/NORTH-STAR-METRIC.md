...
**daily puzzle completers**

Public metric field: `daily_puzzle_completers`.

Distinct users who finish today’s qualifying puzzle ritual.

Do not invent a house score acronym for this quantity.
...
\[
\texttt{daily\_puzzle\_completers}(D) = \bigl|\{ u \mid u \text{ has } \ge 1 \text{ qualifying ritual finish on day } D \}\bigr|
\]

Multiple finishes or multiple games by the same user on day \(D\) still count as **one** toward daily puzzle completers.  
The metric measures **return to complete today’s ritual**, not grind volume.

---

## 2. Qualifying finish (Correctness oracle)

A finish **qualifies** for daily puzzle completers if and only if **all** of the following hold:
...
- Archive play of past days (feeds other metrics, not daily puzzle completers for day \(D\))  
- Entertainment-oracle completions (separate **daily entertainment completers**, public field `daily_entertainment_completers`)  
...
| Candidate | Verdict |
|-----------|---------|
| **daily puzzle completers** | Aligns daily habit, free-tier honesty, suite growth, subscription readiness |
...
**Critical argument:** For a NYT Games–class product, the economic and cultural unit is **“I did today’s thing.”** That unit is daily puzzle completers. Catalog breadth multiplies *reasons* to complete; it must not redefine the unit.
...
|-------|--------|-----------|
| `puzzle_ritual` | **daily puzzle completers** | Positive light learning / brain play |
| `entertainment_oracle` | **daily entertainment completers** (same shape as daily puzzle completers) | Fun, random OK; must not inflate “brain ritual” success |

Product may surface both on the home page; **executive NSM is daily puzzle completers only.**
...
|-------|------|---------------------------|
| **S0** | Instrument | daily puzzle completers recomputable from production events for 7 consecutive days |
| **S1** | One ritual | ≥1 flagship module; D7 *ritual retention* of new daily puzzle completers measurable |
| **S2** | Suite habit | ≥3 puzzle_ritual modules; median modules per daily puzzle completer in a healthy band (not zero, not infinite grind) |
| **S3** | Paid habit | Conversion tracked for users with ≥7 daily-puzzle-completer days in prior 14; free daily finish never removed |

Industry casual-puzzle retention bands vary widely; **do not copy mobile hyper-casual medians as Puzzled OKRs.** Build Puzzled’s own daily-puzzle-completer cohort curves.

---

## 6. Anti-patterns (forbidden “wins”)

1. Counting unfinished starts as daily puzzle completers.  
...
4. Gating the *only* free daily finish behind pay so daily puzzle completers collapse into paid-only.  
5. Optimizing share bots to fake viral without finish quality.  
6. Renaming daily puzzle completers in dashboards without updating this file, or minting a house acronym for the metric.
...
| Data / ops | Dashboard + anomaly alerts on daily-puzzle-completer drop |
