//! Preferences HTTP interfaces (ADR-169).
//!
//! Pure profile/preference validation lives as application helpers; SQL writes
//! are delegated to adapters.
...
use crate::capabilities::preferences::adapters::preferences_db::upsert_user_preferences;
use puzzled_core::product_policy::user_profile_limits::{
