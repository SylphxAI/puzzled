...
//!
//! Letter evaluation reuses [`crate::wordle_eval`]. NO authority_rust / ts_deleted.

use crate::wordle_eval::{evaluate_guess, is_winning_guess, LetterStatus};
...
mod tests {
    use super::*;
    use crate::wordle_eval::WORD_LENGTH;
